...
# JE N'AI NI LE DROIT A PLUS DE 25 LIGNES PAR FONCTION
# NI A PLUS DE 5 FONCTIONS PAR FICHIER
# JE N'AI PAS LE DROIT D'INITIALISER ET DECLARER UNE VARIABLE SUR LA MEME LIGNE
# BOUCLE FOR INTERDIT
# TERNAIRES INTERDIT